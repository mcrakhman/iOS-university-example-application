...
class DescriptionCell: UITableViewCell, ConfigurableCell {
    ...
    @IBOutlet weak var superviewLeadingContainerViewLeadingConstraint: NSLayoutConstraint!
    @IBOutlet weak var containerViewTrailingSuperviewTrailingConstraint: NSLayoutConstraint!
    ...
    override func layoutSubviews() {
        ...
        let width = contentView.frame.width
            - superviewLeadingContainerViewLeadingConstraint.constant
            - containerViewTrailingSuperviewTrailingConstraint.constant
